...
document
  ...
  document.querySelectorAll('.button').forEach(element => {
    ...
    element.addEventListener('click', e => {
        ...
        tl.to(path, {
            d: 'M136,77.5h-1H4.8H4c-2.2,0-4-1.8-4-4v-47c0-2.2,1.8-4,4-4c0,0,0.6,0,0.9,0C44,22.5,66,10,66,10  s3,12.5,69.1,12.5c0.2,0,0.9,0,0.9,0c2.2,0,4,1.8,4,4v47C140,75.7,138.2,77.5,136,77.5z',
            duration: 0.3,
            delay: 0.3
        }).to(path, {
