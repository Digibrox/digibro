function getFormData(denemeValue) {
    let jsonData = {};
    ...
    const inputElement1_11_2 = document.getElementById('1-11_current_selection');
    jsonData["1-11-2_current_selection"] = inputElement1_11_2.value;  // Tutar Seçimi
    ...
    const inputElement2_1 = document.getElementById('2-1_current_selection');
    jsonData["2-1-2_current_selection"] = inputElement2_1.value;
    ...
    const current_selection_3_9_1 = document.getElementById('3-9_current_selection');
    jsonData["3-9-1_current_selection"] = current_selection_3_9_1.value;
    ...
    const current_selection_3_11_1 = document.getElementById('3-11_current_selection');
    jsonData["3-11-1_current_selection"] = current_selection_3_11_1.value;
    //jsonData["3-12-1_current_selection"] = document.getElementById('3-12_current_selection').value;  // Tutar Seçimi
    const current_selection_3_12_1 = document.getElementById('3-12_current_selection');
    jsonData["3-12-1_current_selection"] = current_selection_3_12_1.value;
    //jsonData["3-13-1_current_selection"] = document.getElementById('3-13_current_selection').value;  // Tutar Seçimi
    const current_selection_3_13_1 = document.getElementById('3-13_current_selection');
    jsonData["3-13-1_current_selection"] = current_selection_3_13_1.value;
    //jsonData["3-14-1_current_selection"] = document.getElementById('3-14_current_selection').value;  // Tutar Seçimi
    const current_selection_3_14_1 = document.getElementById('3-14_current_selection');
    jsonData["3-14-1_current_selection"] = current_selection_3_14_1.value;

     // 4. Blok: EC Accordion
     //jsonData["4-1-1_current_selection"] = document.getElementById('4-1_current_selection').value;  // Tutar Seçimi
     const current_selection_4_1_1 = document.getElementById('4-1_current_selection');
    jsonData["4-1-1_current_selection"] = current_selection_4_1_1.value;
    ...
    // jsonData["5-1-1_current_selection"] = document.getElementById('5-1_current_selection').value;  // Tutar Seçimi
     const current_selection5_1_1 = document.getElementById('5-1_current_selection');
    jsonData["5-1-1_current_selection"] = current_selection5_1_1.value;
    ...
    // jsonData["6-1-1_current_selection"] = document.getElementById('6-1_current_selection').value;  // Tutar Seçimi
     const current_selection6_1_1 = document.getElementById('6-1_current_selection');
    jsonData["6-1-1_current_selection"] = current_selection6_1_1.value;
    ...
    // jsonData["7-1-1_current_selection"] = document.getElementById('7-1_current_selection').value;  // Tutar Seçimi
     const current_selection7_1_1 = document.getElementById('7-1_current_selection');
    jsonData["7-1-1_current_selection"] = current_selection7_1_1.value;
    // jsonData["7-2-1_current_selection"] = document.getElementById('7-2_current_selection').value;  // Tutar Seçimi
     const current_selection7_2_1 = document.getElementById('7-2_current_selection');
    jsonData["7-2-1_current_selection"] = current_selection7_2_1.value;
    // jsonData["7-3-1_current_selection"] = document.getElementById('7-3_current_selection').value;  // Tutar Seçimi
     const current_selection7_3_1 = document.getElementById('7-3_current_selection');
    jsonData["7-3-1_current_selection"] = current_selection7_3_1.value;
    // jsonData["7-4-1_current_selection"] = document.getElementById('7-4_current_selection').value;  // Tutar Seçimi
     const current_selection7_4_1 = document.getElementById('7-4_current_selection');
    jsonData["7-4-1_current_selection"] = current_selection7_4_1.value;
     ...
     jsonData["qfqa_id"] = denemeValue;  
     jsonData["last_user"] = "Insurer";  
     
    return jsonData;
}

document.getElementById("save_answers_placement").addEventListener("click", function() {
    //const denemeValue = '{{ basliklar.0.qfqa_id|escapejs }}';
    //console.log(denemeValue);
    let dataToSend = getFormData(denemeValue);
