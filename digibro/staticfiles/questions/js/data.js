function getFormData() {
    ...
    let mail_text_placementElement = document.getElementById("mail_text_placement");
    ...
    } else if (mail_text_placementElement && mail_text_placementElement.value) {
    ...
    let mailTextClientElement = document.getElementById("mail_text_client");

    // Eğer mutluAkuInput mevcut ve değeri varsa, onu kullan
    if (mutluAkuInputElement && mutluAkuInputElement.value) {
